            ...
            <div className="space-y-2 mt-1">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <div className="font-mono text-[10px] text-muted-foreground mt-0.5">{r.id} • {r.channel}</div>
                </div>
                <div className="text-right">
                  <span className={`px-2 py-0.5 rounded-full text-[10px] font-medium uppercase border ${STATUS_COLORS[r.status]}`}>
                    {r.status}
                  </span>
                </div>
              </div>
              <div className="flex items-center justify-between text-body-sm bg-surface-2 p-2 rounded-sm border border-border/50">
                <div className="flex flex-col">
                  <span className="text-[10px] text-muted-foreground uppercase tracking-wide">Dates</span>
